"""
Corrected v3 baseline — single-head Plain ResNet50, patient-grouped 5-fold CV.

Uses the corrected v3 manifest (unified_v3_corrected/) which drops the
duplicated preprocessed Abdalla subset previously labelled 'mendeley'.
"""
import os
import csv
import json
...
parser.add_argument("--tag", type=str, default="v3c_rn50_baseline")
...
MANIFEST_DIR = SCRATCH / "kidney-data/processed/unified_v3_corrected"
